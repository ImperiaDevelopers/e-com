...
export class RegionController {
  ...
  @ApiResponse({ status: 200, description: 'Returns all regions.', type: [Region] })
  @Get('all')
  ...
  @ApiResponse({ status: 200, description: 'The region has been successfully deleted.', type: Number })
  @Delete(':id')
