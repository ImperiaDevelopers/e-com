...
export class DistrictController {
  ...
  @ApiResponse({ status: 201, description: 'The district has been successfully created.', type: District })
  @Post('create')
  ...
  @ApiResponse({ status: 200, description: 'Returns all districts.', type: [District] })
  @Get('all')
  ...
  @ApiResponse({ status: 200, description: 'Returns the district with the specified ID.', type: District })
  @Get(':id')
  ...
  @ApiResponse({ status: 200, description: 'The district has been successfully deleted.', type: Number })
  @Delete(':id')
  ...
  @ApiResponse({ status: 200, description: 'The district has been successfully updated.', type: District })
  @Put(':id')
